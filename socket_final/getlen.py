import os
from myAES import ENCRYPT,DECRYPT
...
if __name__ == '__main__':
    len1 = getlen("F:\\py-test\\key_exchange\\info.txt",'1234567890123456')
    print(len1)
    ...
    res = AES('1234567890123456','kongming234',ENCRYPT)
    out = AES('1234567890123456',res,DECRYPT)
    print(out)
    data = res.encode()
    len2 = len(data)
    # str = '123'
    # bytes.decode(str.encode(),'utf-8','ingore')
    print(len2)